...
try:
    if (
        __obfuscator__ != "Hyperquen" or
        __authors__ != ("QUENPROJECT", "BlueRed") or
        __github__ != "https://github.com/billythegoat356/Hyperion" or
        __discord__ != "https://discord.gg/D2QbAnwF" or
...
__obfuscator__ = 'Hyperquen'
__authors__ = ('QuenProject', 'BlueRed')
__github__ = 'https://github.com/Misquen/hyperquen-'
__discord__ = 'https://discord.gg/D2QbAnwF'
__license__ = 'EPL 2.0'
